...
2) On Canvas you need to submit the url to this GitHub page and the password protecting your videos. (For a1 you don't need a password and as it is a music file only (not video) you can upload it to Soundcloud for instance).
