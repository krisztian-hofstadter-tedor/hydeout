...
3) As a backup, send the GitHub url and the video password as an email to the module tutor (krisztian.hofstadter@anglia.ac.uk) as well.

4) If you could not make the above steps, please send me your portfolio via a file sharing system e.g. [Wetransfer](https://wetransfer.com/). 
